...
setuptools.setup(
    ...
    data_files=[
        ('/var/run/zaggregator', []),
        ('/usr/local/share/zaggregator', ['misc/zaggregator.service', 'misc/zaggregator.conf', 'README.md', 'LICENSE',]),
        ('/usr/local/share/zaggregator/init.d', ['misc/init.d/zaggregator'],),
            ],
